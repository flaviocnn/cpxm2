        ...
        <KeyboardAvoidingView //non funziona credo
            ...
            <ScrollView>
                ...
                <View style={{ paddingTop: 20 }}>
                    <View>
                        <View style={styles.categoryRow}>
                            <Category imageUrl={menHaircut} title='Taglio Uomo' page='Fitness 2000' />
                            <Category imageUrl={uomanHaircut} title='Taglio Donna' page='Fitness 2000' />
                        </View>
                    </View>
                ...
                <View style={{ paddingTop: 10 }}>
                    <View>
                        <View style={styles.categoryRow}>
                            <Category imageUrl={sports} title='Centri Sportivi' page='Fitness 2000' />
                            <Category imageUrl={beautician} title='Cura Personale' page='Fitness 2000' />
                        </View>
                    </View>
                ...
                <View style={{ paddingTop: 10 }}>
                    <View>
                        <View style={styles.categoryRow}>
                            <Category imageUrl={health} title='Visite Mediche' page='Fitness 2000' />
                            <Category imageUrl={fun} title='Svago' page='Fitness 2000' />
                        </View>
                    </View>
